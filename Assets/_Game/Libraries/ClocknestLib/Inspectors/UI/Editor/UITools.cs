...
namespace GameEngine.Utils
{
    ...
    {
        [MenuItem("Clocknest Games/UI/Anchors to Corners %[")]
        ...
        [MenuItem("Clocknest Games/UI/Corners to Anchors %]")]
        ...
        [MenuItem("Clocknest Games/UI/Mirror Horizontally Around Anchors %;")]
        static void MirrorHorizontallyAnchors()
        {
            MirrorHorizontally(false);
        }

        [MenuItem("Clocknest Games/UI/Mirror Horizontally Around Parent Center %:")]
        ...
        [MenuItem("Clocknest Games/UI/Mirror Vertically Around Anchors %'")]
        static void MirrorVerticallyAnchors()
        {
            MirrorVertically(false);
        }

        [MenuItem("Clocknest Games/UI/Mirror Vertically Around Parent Center %\"")]
