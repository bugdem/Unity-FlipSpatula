// Extension of Corgi Engine's MMDebug. 
...
namespace ClocknestGames.Library.Utils
{
	...
	{
		/// whether or not debug logs (CGDebug.DebugLogTime, CGDebug.DebugOnScreen) should be displayed
		...
		public static void DrawRectangle(Rect rectangle, Color color)
		{
			...
			CGDebug.DrawRectangle(pos, color, scale);
		}
